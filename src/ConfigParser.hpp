...
#define ERR_BRACK		"Config File Format: Mismatched brackets\n"
#define ERR_HTTP_DIR	"Config File: Invalid top level directive\n"
#define ERR_SERV_DIR	"Config File: Invalid server block directive\n"
#define ERR_LOCB_DIR	"Config File: Invalid location block directive\n"
#define ERR_NUM_VAL		"Config File: Number value too large for unsigned int\n"
#define ERR_MAX_CLBS	"Config File: Client max body size is too large\n"
#define ERR_DIR			"Config File: Invalid directive\n"
#define ERR_LEX			"Config File: Invalid limit_except directive\n"
#define ERR_TERM		"Config File Format: Invalid or missing directive line terminator\n"
